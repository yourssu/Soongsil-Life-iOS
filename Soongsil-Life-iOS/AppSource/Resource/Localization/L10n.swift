...
enum L10n {
    ...
    enum Settings {
        ...
        static let notificationSettings = text("settings.notification_settings")
        static let gradeNotifications = text("settings.grade_notifications")
        static let chapelNotifications = text("settings.chapel_notifications")
